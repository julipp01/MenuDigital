...
const cardVariants = {
  ...
  exit: { scale: 0.9, opacity: 0, rotateY: -15, transition: { duration: 0.4 } },
};
    ...
    () =>
      models.map((model) => (
        <motion.div
          ...
          className={`relative bg-white rounded-xl overflow-hidden shadow-md cursor-pointer transform transition-all duration-300 ${
        ...
        >
          ...
          <div className="p-2 flex flex-col justify-between bg-gradient-to-t from-gray-50 to-transparent">
            <div>
              <motion.h3
                ...
                animate="animate"
                whileHover="hover"
                className="text-sm font-bold text-gray-900 truncate font-poppins hover:text-orange-500 transition-colors duration-300"
              >
                {model.name}
              </motion.h3>
              <motion.p
                ...
                animate="animate"
                whileHover="hover"
                className="text-xs text-gray-600 line-clamp-2 font-roboto hover:text-gray-800 transition-colors duration-300"
              >
                {model.description}
              </motion.p>
            </div>
            <motion.span
              ...
              animate="animate"
              whileHover="hover"
              className="text-sm font-semibold text-orange-600 font-poppins hover:text-orange-700 transition-colors duration-300"
            >
              {model.price}
            </motion.span>
          </div>
          ...
          >
            <motion.span
              className="text-white font-bold text-xs font-poppins drop-shadow-md"
              initial={{ scale: 0.8 }}
